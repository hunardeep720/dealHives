...
function ProductDescription() {
  ...
  const AddCartHandler = (e, title, asin, image, price, rating) => {
    ...
    if (user) {
      const date = new Date();
      const product = { title, asin, image, price, rating, amount, orderAt: date };
      ...
      {productDetail ? (
        <div>
          ...
          {image ? (
            <div className="grid grid-cols-2 gap-6 my-8">
              ...
              <div>
                ...
                <div className="flex items-center gap-5">
                  <label className="lg:text-xl text-md font-bold">
                    Quantity
                  </label>
                  <input
                    type="number"
            ...
            <div>
              <strong>Sorry we don't have selected product details</strong>
              <p>Please, select any other product</p>
            </div>
          )}
