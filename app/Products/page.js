      ...
      >
        ...
        {productSelect ? (
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-4 xl:grid-cols-6">
            <p className="col-span-full font-extrabold mb-5 text-xl">
              {" "}
              ...
              productsList.map((product) => (
                <div key={product.asin} className="col-span-1 text-center">
                  <Image
                    ...
                    className="w-48 h-48"
                  />
                  <p onClick={HandleProductSelect} className="font-extrabold text-xs hover:cursor-pointer hover:text-slate-500">
